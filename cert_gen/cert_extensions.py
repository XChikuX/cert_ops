"""Certificate extension configurations for different certificate types."""
...
class ExtensionConfig(TypedDict):
    """Configuration for a single certificate extension."""
    extension: x509.ExtensionType
    critical: bool


class CertTypeConfig(TypedDict):
    """Configuration for a certificate type."""
    type: Literal["Root", "Intermediate", "Leaf"]
    parameters: list[ExtensionConfig]
...
EXTENSIONS: dict[str, CertTypeConfig] = {
    "RootCA": {
        "type": "Root",
        "parameters": [
            {
